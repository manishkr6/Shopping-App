  ...
  return (
    <c>
      <nav className="relative bg-gray-800 flex justify-between items-center text-white py-2 px-4 lg:py-2 lg:px-7 md:gap-2 lg:gap-4">
        ...
        <div>
          <ul class="hidden md:flex md:space-x-4 lg:space-x-6 text-[12px] lg:text-[15px] font-medium">
            <li>
        ...
        <div className="overflow-hidden">
          ...
          <button className="relative hover:cursor-pointer">
            <IoCartOutline className="hover:cursor-pointer hover:text-yellow-400 text-xl lg:text-3xl text-white" />
            <span className="bg-rabbit-red absolute -top-2 -right-2 text-black bg-white rounded-full lg:px-2 lg:py-0.5 px-1 lg:font-bold text-[9px] lg:text-xs ">
              4
            </span>
          </button>

          <button>
            <FaRegUser className="hover:cursor-pointer hover:text-yellow-400 text-xl lg:text-2xl text-white" />
          </button>
          <button onClick={() => setIsOpen(!isOpen)} className="md:hidden">
            <HiBars3BottomRight className="text-2xl hover:cursor-pointer" />
          </button>
        </div>
      </nav>
      {/* Mobile Menu */}
